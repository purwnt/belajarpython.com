...
> [Edit this tutorial](https://github.com/belajarpythoncom/belajarpython.com/blob/master/docs/en/tutorial/what-is-python.md)

<div class="flex justify-center md:justify-end mt-8">
    <a href="/en/tutorial/python-installation"
