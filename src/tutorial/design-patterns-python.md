...
<div class="mt-8 inline justify-between gap-x-4 md:flex">
  ...
  <div class="order-1 flex justify-center">
    <a href="/tutorial/unit-testing-python" class="order-1 flex h-12 items-center rounded-full bg-gradient-to-l from-yellow-500 to-yellow-400 px-8 text-base text-black shadow-xl hover:text-black hover:no-underline hover:shadow md:order-2">
